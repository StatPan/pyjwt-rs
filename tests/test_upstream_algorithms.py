...
from jwt_rs.algorithms import HMACAlgorithm, NoneAlgorithm, has_crypto
from jwt_rs.exceptions import InvalidKeyError
...
if has_crypto:
    ...
    from jwt_rs.algorithms import ECAlgorithm, OKPAlgorithm, RSAAlgorithm, RSAPSSAlgorithm
...
class TestECCurveValidation:
    ...
    def test_default_algorithms_have_correct_expected_curve(self) -> None:
        ...
        from jwt_rs.algorithms import get_default_algorithms
